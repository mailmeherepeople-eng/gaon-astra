...
function updateSpeech(){
  ...
  if(speechName.textContent!==talk.who.n)speechName.textContent=talk.who.n;
  if(speechLine.textContent!==talk.line)speechLine.textContent=talk.line;
  const a=talk.anchor;
  ...
  const rect=speechBubble.getBoundingClientRect(),margin=12;
